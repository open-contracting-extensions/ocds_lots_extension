...
```json
{
  ...
  "uri": "https://github.com/open-contracting-extensions/ocds_lots_extension/blob/master/examples/lots.json",
  "extensions":["https://raw.githubusercontent.com/open-contracting-extensions/ocds_lots_extension/v1.1.3/extension.json"],
  "version": "1.1",
  "releases": [
    {
      "language": "en",
